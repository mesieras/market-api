...
use Appsco\Market\ApiBundle\Client\MarketClient;
use Appsco\Market\ApiBundle\Model\Order;
use Appsco\Market\ApiBundle\Service\PrivateKeyProvider\PrivateKeyFileProvider;
...
//        });
    ...
    public function testMakeOrderJwtWithExistingApplication()
    {
        ...
        $client = new MarketClient(
            $encoder = new Encoder(),
            new PrivateKeyFileProvider('file://'.__DIR__.'/key.pem'),
